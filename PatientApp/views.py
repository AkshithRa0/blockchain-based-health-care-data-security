...
def PatientSignupAction(request):
    if request.method == 'POST':
        ...
        output = 'none'
        con = pymysql.connect(host='127.0.0.1',port = 3306,user = 'root', password = 'root', database = 'PatientApp',charset='utf8')
        with con:
            cur = con.cursor()
        ...
        if output == "none":
            db_connection = pymysql.connect(host='127.0.0.1',port = 3306,user = 'root', password = 'root', database = 'PatientApp',charset='utf8')
